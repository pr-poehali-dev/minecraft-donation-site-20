          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground ml-6">
                  Свяжитесь с администрацией через Telegram или Discord и опишите ситуацию. Мы рассмотрим вашу жалобу.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground ml-6">
                  Возврат средств возможен только в случае технической ошибки при выдаче привилегии. Свяжитесь с поддержкой в течение 24 часов после покупки.
                </p>
              </div>
            </CardContent>
          </Card>
